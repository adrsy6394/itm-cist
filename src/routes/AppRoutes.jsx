...
const OrganizingCommittee = lazy(
  () => import("../pages/Committee/OrganizingCommittee"),
);
const TechnicalCommittee = lazy(
  () => import("../pages/Committee/TechnicalCommittee"),
);
const AdvisoryCommittee = lazy(
  () => import("../pages/Committee/AdvisoryCommittee"),
);
const SocialMediaCommittee = lazy(
  () => import("../pages/Committee/SocialMediaCommittee"),
);
const HospitalityCommittee = lazy(
  () => import("../pages/Committee/HospitalityCommittee"),
);
const RegistrationCommittee = lazy(
  () => import("../pages/Committee/RegistrationCommittee"),
);
...
const RegITMStudents = lazy(
  () => import("../pages/Registration/RegITMStudents"),
);
      ...
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route path="about">
            <Route
              index
              element={<Navigate to="/about/itm" replace />}
            />
          ...
          <Route path="committee">
            <Route
              index
              element={<Navigate to="/committee/advisory" replace />}
            />
