...
export const CONVENER_MEMBERS = [
  { id: 'cv1', name: 'Dr. Ashutosh Gupta', imageSrc: '/committee/Ashutosh Gupta.jpeg' },
  // { id: 'cv2', name: 'Er. Pavnesh Kumar', imageSrc: '/committee/Ashutosh Gupta.jpeg' },
...
export const ADVISORY_MEMBERS = [
  { id: 'ac1',  name: 'Dr. Rajendra Kumar Pandey',                          imageSrc: '' },
  { id: 'ac2',  name: 'Er. Shivanand Roy',                                  imageSrc: '' },
  { id: 'ac3',  name: 'Dr. Nirmal Das',                                      imageSrc: '' },
  { id: 'ac4',  name: 'Er. J. B. Rai',                                      imageSrc: '' },
  { id: 'ac5',  name: 'Dr. Pawan Kumar Mishra',                             imageSrc: '' },
  { id: 'ac6',  name: 'Er. M. W. Beg',                                      imageSrc: '' },
  { id: 'ac7',  name: 'Prof. Y. N. Singh',                                   imageSrc: '' },
  { id: 'ac8',  name: 'Prof. Kumar Vaibhav',                                imageSrc: '' },
  { id: 'ac9',  name: 'Prof. S. N. Singh',                                  imageSrc: '' },
  { id: 'ac10', name: 'Prof. Bharat Lohani',                                imageSrc: '' },
  { id: 'ac11', name: 'Prof. S. C. Srivastava',                             imageSrc: '' },
  { id: 'ac12', name: 'Dr. Ankit Gupta',                                    imageSrc: '' },
  { id: 'ac13', name: 'Dr. P. K. Singh',                                    imageSrc: '' },
  { id: 'ac14', name: 'Dr. Ashutosh Kr. Singh',                             imageSrc: '' },
  { id: 'ac15', name: 'Prof. D. S. Kushwaha',                               imageSrc: '' },
  { id: 'ac16', name: 'Prof. Vinod Yadav',                                  imageSrc: '' },
  { id: 'ac17', name: 'Prof. Rajesh Gupta',                                 imageSrc: '' },
  { id: 'ac18', name: 'Prof. Nitin Singh',                                  imageSrc: '' },
  { id: 'ac19', name: 'Prof. R. P. Tiwari',                                 imageSrc: '' },
  { id: 'ac20', name: 'Dr. Vikash Gaur',                                    imageSrc: '' },
  { id: 'ac21', name: 'Prof. Monika Mittal',                                imageSrc: '' },
  { id: 'ac22', name: 'Prof. Vikas Mittal',                                 imageSrc: '' },
  { id: 'ac23', name: 'Dr. Alok Das',                                       imageSrc: '' },
  { id: 'ac24', name: 'Prof. Surender Kumar',                               imageSrc: '' },
  { id: 'ac25', name: 'Prof. P. K. Singh',                                  imageSrc: '' },
  { id: 'ac26', name: 'Prof. Vishwa Nath Nanda',                            imageSrc: '' },
  { id: 'ac27', name: 'Prof. Krishna Raj',                                  imageSrc: '' },
  { id: 'ac28', name: 'Prof. Manoj Shukla',                                 imageSrc: '' },
  { id: 'ac29', name: 'Prof. Vandana Dixit',                                imageSrc: '' },
  { id: 'ac30', name: 'Dr. K. S. Verma',                                    imageSrc: '' },
  { id: 'ac31', name: 'Prof. C. K. Tiwari',                                 imageSrc: '' },
  { id: 'ac32', name: 'Prof. (Dr.) Raghuraj Singh',                         imageSrc: '' },
  { id: 'ac33', name: 'Prof. Govind Pandey',                                imageSrc: '' },
  { id: 'ac34', name: 'Dr. Rakesh Kumar',                                   imageSrc: '' },
  { id: 'ac35', name: 'Prof. Mahesh Pal',                                   imageSrc: '' },
  { id: 'ac36', name: 'Prof. A. K. Mishra',                                 imageSrc: '' },
  { id: 'ac37', name: 'Prof. Murad Ali',                                    imageSrc: '' },
  { id: 'ac38', name: 'Dr. R. C. S. Chauhan',                               imageSrc: '' },
]
